...
import com.JsonBean.ShopJdBean;
 ...
 */
public class Activity_ShopJd extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shop_jiudian);
    ...
    private void storeMessage() {
        ...
        params.addQueryStringParameter("status", 1 + "");//1(酒店)2(饭店)3(商品)
        HttpUtils http = new HttpUtils();
        http.configResponseTextCharset("UTF_8");
        http.configCurrentHttpCacheExpiry(0 * 1000);
        http.send(HttpRequest.HttpMethod.GET, URL.storeMessage, params,
                new RequestCallBack<String>() {
                    DialogProgressbar dialogProgressbar=new DialogProgressbar(Activity_ShopJd.this,R.style.AlertDialogStyle);
                    @Override
                    public void onStart() {
                        super.onStart();
                    ...
                    public void onSuccess(ResponseInfo<String> responseInfo) {
                        ...
                        try {
                            ShopJdBean bean = new Gson().fromJson(responseInfo.result, ShopJdBean.class);
