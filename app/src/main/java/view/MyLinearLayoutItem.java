...
public class MyLinearLayoutItem extends LinearLayout {
    ...
    private void initView(Context context){
        ...
        ImageView left_Image= (ImageView) findViewById(R.id.im_adapter_my_left);
    ...
    public void setOnColick(OnClickListener listener){
        if (null != listener)
            ll_myview.setOnClickListener(listener);
    }
}
