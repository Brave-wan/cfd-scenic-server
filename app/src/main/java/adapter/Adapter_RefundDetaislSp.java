 ...
 */
public class Adapter_RefundDetaislSp extends BaseAdapter {
    Context mContext;
    List<FindOrderDetailSpBean.DataBean.MapBean> list;

    public Adapter_RefundDetaislSp(Context mContext, List<FindOrderDetailSpBean.DataBean.MapBean> list) {
