 ...
 */
public class Adapter_Statistics_Jd extends BaseAdapter {
    Context mContext;
    Activity_Statistics activity;
    List<OrderCountJdBean.DataBean.OrderListBean> rows;

    public Adapter_Statistics_Jd(Context mContext, List<OrderCountJdBean.DataBean.OrderListBean> list_jd) {
